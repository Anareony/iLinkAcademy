...
const FeedbackCard: React.FC<IFeedback> = ({name, surname, about, avatar, position, date}) => {
    return (
        <Feedback>
            <Container>
                <Header>
